...
namespace PlanRecognitionExtension
{
    internal class EarleyPlanner : PartialObservabilityEarleyParser
    {
        ...
        internal static Subplan GetSingleGoalTaskFromSequence(List<Subplan> groundedSubtasks)
        {
        ...
        {
            return GetSingleGoalTaskFromSequence(groundedSubtasks);
        }

        internal override int ComputeNumberOfFlaws(List<ActionSubplan> plan)
        {
            return plan.Count;
